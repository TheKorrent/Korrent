...
interface QBittorrentService {
    ...
    suspend fun setPreferences(@Field("json") preferences: String)
    ...
    suspend fun setCookies(@Field("cookies") cookies: String)
    ...
    suspend fun getPeerLogs(@Query("last_known_id") lastKnownId: Int = -1): Array<QBittorrentPeerLog>

    @GET("/api/v2/sync/maindata")
    suspend fun getSyncMainData(@Query("rid") rid: Int = -1): QBittorrentSyncMainData

    @GET("/api/v2/sync/torrentPeers")
    suspend fun getSyncPeersData(@Query("hash") hash: String): QBittorrentSyncPeersData
    ...
    suspend fun setGlobalDownloadLimit(@Field("limit") limit: Int)
    ...
    suspend fun setGlobalUploadLimit(@Field("limit") limit: Int)

    @FormUrlEncoded
    @POST("/api/v2/transfer/banPeers")
    suspend fun banPeers(@Field("peers") peers: String)
    ...
    suspend fun getTorrentGenericProperty(@Query("hash") hash: String): QBittorrentTorrentProperty

    @GET("/api/v2/torrents/trackers")
    suspend fun getTorrentTrackers(@Query("hash") hash: String): Array<QBittorrentTracker>

    @GET("/api/v2/torrents/webseeds")
    suspend fun getTorrentWebSeeds(@Query("hash") hash: String): Array<QBittorrentWebSeed>

    @GET("/api/v2/torrents/files")
    suspend fun getTorrentContents(@Query("hash") hash: String, @Query("indexes") indexes: String? = null): Array<QBittorrentTorrentContent>

    @GET("/api/v2/torrents/pieceStates")
    suspend fun getTorrentPiecesStates(@Query("hash") hash: String): Array<Int>

    @GET("/api/v2/torrents/pieceHashes")
    suspend fun getTorrentPiecesHashes(@Query("hash") hash: String): Array<String>

    @FormUrlEncoded
    @POST("/api/v2/torrents/stop")
    suspend fun stopTorrents(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/start")
    suspend fun startTorrents(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/delete")
    suspend fun removeTorrents(@Field("hashes") hashes: String, @Field("deleteFiles") deleteFiles: Boolean)

    @FormUrlEncoded
    @POST("/api/v2/torrents/recheck")
    suspend fun recheckTorrents(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/reannounce")
    suspend fun reannounceTorrents(@Field("hashes") hashes: String)
    ...
    suspend fun addTorrentTrackers(@Field("hash") hash: String, @Field("urls") urls: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/editTracker")
    suspend fun editTorrentTracker(@Field("hash") hash: String, @Field("origUrl") origUrl: String, @Field("newUrl") newUrl: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/removeTrackers")
    suspend fun removeTorrentTrackers(@Field("hash") hash: String, @Field("urls") urls: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/addPeers")
    suspend fun addTorrentPeers(@Field("hashes") hashes: String, @Field("peers") peers: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/increasePrio")
    suspend fun increaseTorrentPriority(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/decreasePrio")
    suspend fun decreaseTorrentPriority(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/topPrio")
    suspend fun maximalTorrentPriority(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/bottomPrio")
    suspend fun minimalTorrentPriority(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/filePrio")
    suspend fun setTorrentFilePriority(@Field("hash") hash: String, @Field("id") id: Int, @Field("priority") priority: Int)

    @GET("/api/v2/torrents/downloadLimit")
    suspend fun getTorrentDownloadLimit(@Query("hashes") hashes: String): Map<String, Int>

    @FormUrlEncoded
    @POST("/api/v2/torrents/setDownloadLimit")
    suspend fun setTorrentDownloadLimit(@Field("hashes") hashes: String, @Field("limit") limit: Int)
    ...
    suspend fun getTorrentUploadLimit(@Query("hashes") hashes: String): Map<String, Int>

    @FormUrlEncoded
    @POST("/api/v2/torrents/setUploadLimit")
    suspend fun setTorrentUploadLimit(@Field("hashes") hashes: String, @Field("limit") limit: Int)

    @FormUrlEncoded
    @POST("/api/v2/torrents/setLocation")
    suspend fun setTorrentLocation(@Field("hashes") hashes: String, @Field("location") location: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/rename")
    suspend fun renameTorrent(@Field("hash") hash: String, @Field("name") name: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/setCategory")
    suspend fun setTorrentCategory(@Field("hashes") hashes: String, @Field("category") category: String)
    ...
    suspend fun createCategory(@Field("category") category: String, @Field("savePath") savePath: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/editCategory")
    suspend fun editCategory(@Field("category") category: String, @Field("savePath") savePath: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/removeCategories")
    suspend fun removeCategories(@Field("categories") categories: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/addTags")
    suspend fun addTorrentTag(@Field("hashes") hashes: String, @Field("tags") tags: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/removeTags")
    suspend fun removeTorrentTag(@Field("hashes") hashes: String, @Field("tags") tags: String)
    ...
    suspend fun createTags(@Field("tags") tags: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/deleteTags")
    suspend fun deleteTags(@Field("tags") tags: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/setAutoManagement")
    suspend fun setAutomaticTorrentManagement(@Field("hashes") hashes: String, @Field("enable") enable: Boolean)

    @FormUrlEncoded
    @POST("/api/v2/torrents/toggleSequentialDownload")
    suspend fun toggleSequentialDownload(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/toggleFirstLastPiecePrio")
    suspend fun toggleFirstLastPiecePriority(@Field("hashes") hashes: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/setForceStart")
    suspend fun setForceStart(@Field("hashes") hashes: String, @Field("value") value: Boolean)

    @FormUrlEncoded
    @POST("/api/v2/torrents/setSuperSeeding")
    suspend fun setSuperSeeding(@Field("hashes") hashes: String, @Field("value") value: Boolean)

    @FormUrlEncoded
    @POST("/api/v2/torrents/renameFile")
    suspend fun renameTorrentFile(@Field("hash") hash: String, @Field("oldPath") oldPath: String, @Field("newPath") newPath: String)

    @FormUrlEncoded
    @POST("/api/v2/torrents/renameFolder")
    suspend fun renameTorrentFolder(@Field("hash") hash: String, @Field("oldPath") oldPath: String, @Field("newPath") newPath: String)

    @FormUrlEncoded
    @POST("/api/v2/rss/addFolder")
    suspend fun addRssFolder(@Field("path") path: String)

    @FormUrlEncoded
    @POST("/api/v2/rss/addFeed")
    suspend fun addRssFeed(@Field("url") url: String, @Field("path") path: String? = null)

    @FormUrlEncoded
    @POST("/api/v2/rss/removeItem")
    suspend fun removeRssFeed(@Field("path") path: String)

    @FormUrlEncoded
    @POST("/api/v2/rss/moveItem")
    suspend fun moveRssFeed(@Field("itemPath") itemPath: String, @Field("destPath") destPath: String)

    @GET("/api/v2/rss/items")
    suspend fun getRssFeeds(@Query("withData") withData: Boolean): String

    @FormUrlEncoded
    @POST("/api/v2/rss/markAsRead")
    suspend fun markRssAsRead(@Field("itemPath") itemPath: String, @Field("articleId") articleId: String? = null)

    @FormUrlEncoded
    @POST("/api/v2/rss/refreshItem")
    suspend fun refreshRssFeed(@Field("itemPath") itemPath: String)

    @FormUrlEncoded
    @POST("/api/v2/rss/setRule")
    suspend fun setRssRule(@Field("ruleName") ruleName: String, @Field("ruleDef") ruleDef: String)

    @FormUrlEncoded
    @POST("/api/v2/rss/renameRule")
    suspend fun renameRssRule(@Field("ruleName") ruleName: String, @Field("newRuleName") newRuleName: String)

    @FormUrlEncoded
    @POST("/api/v2/rss/removeRule")
    suspend fun removeRssRule(@Field("ruleName") ruleName: String)

    @GET("/api/v2/rss/rules")
    suspend fun getRssRules(): Map<String, QBittorrentRssRule>

    @GET("/api/v2/rss/matchingArticles")
    suspend fun matchingRssArticles(@Query("ruleName") ruleName: String): Map<String, Array<String>>

    @FormUrlEncoded
    @POST("/api/v2/search/start")
    suspend fun startSearch(@Field("pattern") pattern: String, @Field("plugins") plugins: String, @Field("category") category: String): QBittorrentSearchId

    @FormUrlEncoded
    @POST("/api/v2/search/stop")
    suspend fun stopSearch(@Field("id") id: Int)

    @GET("/api/v2/search/status")
    suspend fun getSearchStatus(@Query("id") id: Int? = null): Array<QBittorrentSearchStatus>

    @GET("/api/v2/search/results")
    suspend fun getSearchResults(@Query("id") id: Int, @Query("limit") limit: Int? = null, @Query("offset") offset: Int? = null): QBittorrentSearchResult

    @FormUrlEncoded
    @POST("/api/v2/search/delete")
    suspend fun deleteSearchResult(@Field("id") id: Int)
    ...
    suspend fun installSearchPlugin(@Field("sources") sources: String)

    @FormUrlEncoded
    @POST("/api/v2/search/uninstallPlugin")
    suspend fun uninstallSearchPlugin(@Field("names") names: String)

    @FormUrlEncoded
    @POST("/api/v2/search/enablePlugin")
    suspend fun enableSearchPlugin(@Field("names") names: String, @Field("enable") enable: Boolean)
