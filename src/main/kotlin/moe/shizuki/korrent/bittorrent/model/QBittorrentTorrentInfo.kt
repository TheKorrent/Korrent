...
data class QBittorrentTorrentInfo(
    ...
    @field:JsonProperty("dlspeed") val dlspeed: Int?,
    @field:JsonProperty("download_path") val downloadPath: String?,
    @field:JsonProperty("downloaded") val downloaded: Long?,
    @field:JsonProperty("downloaded_session") val downloadedSession: Int?,
    ...
    @field:JsonProperty("max_ratio") val maxRatio: Int?,
    ...
    @field:JsonProperty("ratio_limit") val ratioLimit: Int?,
    ...
    @field:JsonProperty("seeding_time_limit") val seedingTimeLimit: Int?,
    ...
    @field:JsonProperty("upspeed") val upspeed: Int?
)
